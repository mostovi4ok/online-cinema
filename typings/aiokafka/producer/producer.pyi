...
class AIOKafkaProducer:
    ...
    async def partitions_for(self, topic):  # -> Set[int]:
        """Returns set of all known partitions for the topic."""

    async def send(self, topic, value=..., key=..., partition=..., timestamp_ms=..., headers=...):
    ...
    async def send_and_wait(self, topic, value=..., key=..., partition=..., timestamp_ms=..., headers=...):
    ...
    async def send_batch(self, batch, topic, *, partition):  # -> Future[Any]:
