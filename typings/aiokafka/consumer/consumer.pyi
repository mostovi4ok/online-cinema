...
class AIOKafkaConsumer:
    ...
    async def getone(self, *partitions: TopicPartition) -> ConsumerRecord[str, DataFileReader]:
        """
    ...
    async def getmany(
        self, *partitions: tuple[str], timeout_ms: int | None = ..., max_records: int | None = ...
    ) -> dict[TopicPartition, list[ConsumerRecord[str, DataFileReader]]]: ...
