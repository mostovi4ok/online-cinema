...
class AbstractConnection:
    ...
    def __init__(
        ...
        protocol: int | None = ...,
        command_packer: Callable[[], None] | None = ...,
    ) -> None:
        """
...
class Connection(AbstractConnection):
    ...
    def __init__(
        self, host=..., port=..., socket_keepalive=..., socket_keepalive_options=..., socket_type=..., **kwargs
    ) -> None: ...
    def repr_pieces(self):  # -> list[tuple[str, str] | tuple[str, int]]:
        ...
...
class ConnectionPool:
    ...
    def __init__(self, connection_class=..., max_connections: int | None = ..., **connection_kwargs) -> None: ...
...
class BlockingConnectionPool(ConnectionPool):
    ...
    def __init__(
        self, max_connections=..., timeout=..., connection_class=..., queue_class=..., **connection_kwargs
    ) -> None: ...
    def reset(self):  # -> None:
        ...
    def make_connection(self):  # -> Connection:
