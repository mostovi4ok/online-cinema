...
class SearchCommands:
    ...
    def create_index(
        ...
        definition: IndexDefinition | None = ...,
        max_text_fields=...,
        temporary=...,
        no_highlight: bool = ...,
        no_term_frequencies: bool = ...,
    ...
    def get_params_args(self, query_params: dict[str, str | int | float | bytes] | None):  # -> list[Any]:
        ...
    def search(
        self, query: str | Query, query_params: dict[str, str | int | float | bytes] | None = ...
    ):  # -> Pipeline:
        """
    ...
    def explain(self, query: str | Query, query_params: dict[str, str | int | float] = ...):
    ...
    def aggregate(self, query: str | Query, query_params: dict[str, str | int | float] = ...):
        """
    ...
    def spellcheck(self, query, distance=..., include=..., exclude=...):
        """
...
class AsyncSearchCommands(SearchCommands):
    ...
    async def search(self, query: str | Query, query_params: dict[str, str | int | float] = ...):  # -> Pipeline:
        """
        Search the index for a given query, and return a result of documents
    ...
    async def aggregate(self, query: str | Query, query_params: dict[str, str | int | float] = ...):
        """
        Issue an aggregation query.
