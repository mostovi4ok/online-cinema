...
class RedisCluster(AbstractRedisCluster, RedisClusterCommands):
    ...
    def lock(
        self, name, timeout=..., sleep=..., blocking=..., blocking_timeout=..., lock_class=..., thread_local=...
    ):  # -> Lock:
        """
...
class ClusterPubSub(PubSub):
    ...
    def __init__(self, redis_cluster, node=..., host=..., port=..., push_handler_func=..., **kwargs) -> None:
        """
...
class ClusterPipeline(RedisCluster):
    ...
    def __init__(
        ...
        result_callbacks: dict[str, Callable] | None = ...,
        cluster_response_callbacks: dict[str, Callable] | None = ...,
        startup_nodes: list[ClusterNode] | None = ...,
        read_from_replicas: bool = ...,
        cluster_error_retry_attempts: int = ...,
        reinitialize_steps: int = ...,
