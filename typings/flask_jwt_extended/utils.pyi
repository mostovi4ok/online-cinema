...
def get_jwt_request_location() -> str | None:
    """
...
def decode_token(encoded_token: str, csrf_value: str | None = ..., allow_expired: bool = ...) -> dict:
    """
...
def create_refresh_token(
    identity: Any, expires_delta: ExpiresDelta | None = ..., additional_claims=..., additional_headers=...
):  # -> str:
    """
...
def get_jti(encoded_token: str) -> str | None:
    """
...
def set_access_cookies(response: Response, encoded_access_token: str, max_age=..., domain=...) -> None:
    """
...
def set_refresh_cookies(
    response: Response, encoded_refresh_token: str, max_age: int | None = ..., domain: str | None = ...
) -> None:
    """
