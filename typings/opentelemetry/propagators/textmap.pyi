...
CarrierValT: typing.TypeAlias = list[str] | str
...
class DefaultGetter(Getter[typing.Mapping[str, CarrierValT]]):
    def get(self, carrier: typing.Mapping[str, CarrierValT], key: str) -> list[str] | None:
...
class TextMapPropagator(abc.ABC):
    ...
    @abc.abstractmethod
    def extract(self, carrier: CarrierT, context: Context | None = ..., getter: Getter[CarrierT] = ...) -> Context:
    ...
    @abc.abstractmethod
    def inject(self, carrier: CarrierT, context: Context | None = ..., setter: Setter[CarrierT] = ...) -> None:
