...
class AsyncClient:
    ...
    async def query_column_block_stream(
        self,
        query: str | None = ...,
        parameters: Sequence | dict[str, Any] | None = ...,
        settings: dict[str, Any] | None = ...,
    ...
    async def insert_arrow(
        self, table: str, arrow_table, database: str = ..., settings: dict | None = ...
    ) -> QuerySummary:
        """
    ...
    async def create_insert_context(
        self,
        table: str,
